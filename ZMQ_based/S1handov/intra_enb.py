...
class intra_enb(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._cell_gain0_range = Range(0, 1, 0.1, 0, 200)
        ...
        self.zeromq_rep_sink_1_0 = zeromq.rep_sink(gr.sizeof_gr_complex, 1, 'tcp://*:2102', 100, False, -1)
